<%@ control language="C#" autoeventwireup="true" inherits="Administrators_ManageUsers, App_Web_5p0leyam" %>
...
<asp:GridView ID="UserProfilesGridView" SkinID="GridView" runat="server" AllowPaging="True"
    ...
    <Columns>
        ...
        <asp:TemplateField>
            <ItemTemplate>
                <asp:LinkButton ID="DeleteProfileHyperLink" runat="server" CommandName='Ban'
                    CommandArgument='<%# Eval("Email") %>' Text='Ban' ToolTip="Delete Profile"></asp:LinkButton>
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
    <EmptyDataTemplate>
