...
namespace Simple.Providers.MySQL
{
    ...
    public sealed class MysqlRoleProvider : RoleProvider
    {
        ...
        private string eventSource = "SimpleMysqlRoleProvider";
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            if (name == null || name.Length == 0)
                name = "SimpleMysqlRoleProvider";

            if (String.IsNullOrEmpty(config["description"]))
            {
                config.Remove("description");
                config.Add("description", "Simple MySQL Role provider");
            }
        ...
        public override bool IsUserInRole(string username, string rolename)
        {
            ...
            try
            {
                ...
                int numRecs = int.Parse(cmd.ExecuteScalar().ToString());
