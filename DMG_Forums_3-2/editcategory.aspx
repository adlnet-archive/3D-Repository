<%@ Page language="VB" Inherits="DMGForums.Forums.EditCategory" %>
...
<HTML>
	<HEAD>
		<DMG:Settings CustomTitle="Edit Category" runat="server" />
	</HEAD>
	<BODY>
		<form runat="server">
	...
	<tr class="HeaderCell">
	<td align="left">
		<font size="<%=Settings.HeaderSize%>" color="<%=Settings.HeaderFontColor%>"><b>Edit Category</b></font>
	</td>
	</tr>
	<tr class="TableRow1">
	<td style="border-top:1px solid <%=Settings.TableBorderColor%>;">
		...
		<tr>
			...
			<td align="left" valign="middle">
				...
				<asp:Button type="submit" id="SubmitButton" onclick="EditCategory" text="Save Changes" runat="server" />
			</td>
		</tr>
		</table>
	</td>
