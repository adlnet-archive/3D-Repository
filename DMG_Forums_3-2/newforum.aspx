<%@ Page language="VB" Inherits="DMGForums.Forums.NewForum" maintainScrollPositionOnPostBack="true" %>
...
<HTML>
	<HEAD>
		<DMG:Settings CustomTitle="New Forum" runat="server" />
	</HEAD>
	<BODY>
		<form runat="server">
	...
	<tr class="HeaderCell">
	<td align="left">
		<font size="<%=Settings.HeaderSize%>" color="<%=Settings.HeaderFontColor%>"><b>Post New Forum</b></font>
	</td>
	</tr>
	<tr class="TableRow1">
	<td style="border-top:1px solid <%=Settings.TableBorderColor%>;">
		...
		<tr>
			...
			<td align="left" valign="middle">
				<font size="2" color="<%=Settings.TopicsFontColor%>"><asp:Label id="CategoryName" runat="server" /></font>
			</td>
		</tr>
		<tr>
			<td align="right" valign="middle">
		...
		<tr>
			...
			<td align="left" valign="middle">
				<asp:DropDownList id="txtShowLatest" runat="server">
					<asp:ListItem Value="1" Text="Yes" Selected="True" runat="server" />
		...
		<tr>
			...
			<td align="left" valign="middle">
				...
				<font size="2"><br />(Enter An Integer, Default Is 1)</font>
			</td>
		</tr>
		<tr>
			<td align="right" valign="top">
		...
		<tr>
			...
			<td align="left" valign="top">
				...
				<td align="left" valign="top">
					<font size="2" color="<%=Settings.TopicsFontColor%>">Selected</font><br />
					<asp:ListBox id="txtAllowedModerators" runat="server" />
				</td>
				</tr>
				</table>
			</td>
		...
		<tr>
			...
			<td align="left" valign="middle">
				...
				<asp:Button type="submit" id="SubmitButton" onclick="SubmitForum" text="Submit Forum" runat="server" />
			</td>
		</tr>
		</table>
	</td>
