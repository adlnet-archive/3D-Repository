<%@ Page language="VB" Inherits="DMGForums.EditPageForm" maintainScrollPositionOnPostBack="true" %>
...
<HTML>
	<HEAD>
		<DMG:Settings CustomTitle="Edit Page" runat="server" />
	</HEAD>
	<BODY>
		<form runat="server">
	...
	<td style="border-top:1px solid <%=Settings.TableBorderColor%>;">
		...
		<td align="center" valign="middle" height="40" colspan="2">
			<font size="4" color="<%=Settings.TopicsFontColor%>"><b>Edit Page</b></font>
		</td>
		</tr>
		<tr>
		<td colspan="2">
			...
			<tr>
				<td align="right" valign="middle">
					<font size="2" color="<%=Settings.TopicsFontColor%>"><b>Page ID:</b></font>
				</td>
				<td align="left" valign="middle">
					<asp:Textbox id="txtPageID" size="10" runat="server" />
				</td>
			</tr>
			<tr>
				<td align="right" valign="middle">
				...
				<td align="left" valign="middle">
					<asp:Textbox id="txtName" size="30" maxlength="100" runat="server" />
				</td>
			</tr>
			<tr>
				...
				<td align="left" valign="middle">
					<asp:DropDownList id="txtParent" runat="server" />
				</td>
			</tr>
			<tr>
				<td align="right" valign="middle">
				...
				<td align="left" valign="middle">
					<asp:Textbox id="txtTitle" size="60" maxlength="100" runat="server" />
				</td>
			</tr>
			<tr>
				<td align="right" valign="middle">
		...
		<td width="50%" align="center" valign="top">
			...
			<tr>
				...
				<td align="left" valign="middle">
					<asp:Textbox id="txtSubTitle" size="20" maxlength="100" runat="server" />
				</td>
			</tr>
			<tr>
				<td align="right" valign="top">
			...
			<tr>
				...
				<td align="left" valign="middle">
					<asp:Textbox id="txtSubColumns" size="5" runat="server" />
				</td>
			</tr>
			<tr>
				<td align="right" valign="top">
				...
				<td align="left" valign="middle">
					<asp:DropDownList id="txtSubAlign" runat="server">
						<asp:ListItem Value="1" Text="Left" runat="server" />
		...
		<td colspan="2" align="center" height="40" valign="middle">
			<asp:Button type="submit" id="SubmitButton" onclick="EditPage" text="Save Changes" CssClass="AdminButtons" runat="server" />
		</td>
		</tr>
		</table>
