<%@ Page language="VB" Inherits="DMGForums.Topics.DeleteReply" %>
...
<HTML>
	<HEAD>
		<DMG:Settings CustomTitle="Delete Reply" runat="server" />
	</HEAD>
	<BODY>
		<form runat="server">
	...
	<tr class="HeaderCell">
	<td align="left">
		<font size="<%=Settings.HeaderSize%>" color="<%=Settings.HeaderFontColor%>"><b>Delete Reply</b></font>
	</td>
	</tr>
	...
	<td style="border-top:1px solid <%=Settings.TableBorderColor%>;">
		<font size="2" color="<%=Settings.TopicsFontColor%>"> 
			<b>Warning:</b> This action can not be undone.  Pressing the delete button will completely remove the reply from the database.
			<br /><br />
			<center>
			<asp:Textbox id="TopicID" visible="false" runat="server" />
			<asp:Button type="submit" id="DeleteButton" onclick="DeleteReply" text="Delete Reply" runat="server" />
			</center>
		</font>
	</td>
	</tr>
